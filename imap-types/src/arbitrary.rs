...
fn arbitrary_search_key_limited<'a>(
    ...
    Ok(match u.int_in_range(0u8..=till)? {
        ...
        14 => SearchKey::Larger(u64::arbitrary(u)? & i64::MAX as u64),
        15 => SearchKey::New,
        ...
        26 => SearchKey::Smaller(u64::arbitrary(u)? & i64::MAX as u64),
...
fn arbitrary_search_key_leaf<'a>(u: &mut Unstructured<'a>) -> arbitrary::Result<SearchKey<'a>> {
    Ok(match u.int_in_range(0u8..=33)? {
        ...
        13 => SearchKey::Larger(u64::arbitrary(u)? & i64::MAX as u64),
        14 => SearchKey::New,
        15 => SearchKey::Old,
        ...
        23 => SearchKey::Smaller(u64::arbitrary(u)? & i64::MAX as u64),
            ...
            body: Body {
                ...
                specific: match u.int_in_range(1..=3)? {
                    ...
                    2 => SpecificFields::Message {
                        ...
                        number_of_lines: u64::arbitrary(u)? & i64::MAX as u64,
                    },
